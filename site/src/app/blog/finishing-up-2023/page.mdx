...
export const article = {
  ...
  description: "As the end of 2023 approaches, we'd like to provide an update on what we have done, what we have learned, and what we have planned for next year.",
  author: {
